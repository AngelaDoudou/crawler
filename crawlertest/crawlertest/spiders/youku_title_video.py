...
class YoukuSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        print label
        for title in response.xpath('/html/body/div[@class="s-body"]/div/div[@class="vaule_main"]/div[@class="box-video"]/div/div/div/ul[@class="info-list"]/li[@class="title"]/a/@title').extract():
